...
public void GetItemsForCategoryCallback(int[] ids, int count, any hPack)
{
	...
	AddMenuItem(hMenu, sItem, sDisplay, (Store_GetCategoryServerRestriction(categoryId) && !Store_ProcessCategory(Store_GetServerID(), categoryId)) ? ITEMDRAW_DEFAULT : ITEMDRAW_DISABLED);
}
