...
void LoadConfig(const char[] sName, const char[] sFile) 
{
	...
	KvGetString(hKV, "credits_choices", creditChoicesString, sizeof(creditChoicesString));
...
{
	Handle menu = CreateMenu(giftType == GiftType_Credits ? ChoosePlayerCreditsMenuSelectHandle : ChoosePlayerItemMenuSelectHandle);
