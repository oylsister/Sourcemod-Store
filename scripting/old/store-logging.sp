...
void Log_File(Handle hPlugin, const char[] sPath = "", const char[] sFile = "store", const char[] sDate = "", ELOG_LEVEL eLevel = INFORMATIONAL, bool bLogToFolder = false, const char[] format, any ...)
{
